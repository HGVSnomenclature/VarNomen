...
The basic format to describe un-sequenced deletions is: **(last-normal_first-deleted)_ (last-deleted_first-normal)**. Descriptions differ based on the technology used to detect the rearrangement:
	...
	*	MLPA
	...
	:	_**NOTE**_: when a probe location is used the recommendation is to use the central position, for MLPA the 3' nucleotide of the probe ligation site. For details [_see Deletions_](/recommendations/DNA/variant/deletion/) or [_Duplications_](/recommendations/DNA/variant/duplication/).
	*	PCR
